...
### Fonte
- **Balsamiq Sans** por Michael Angeles: https://fonts.google.com/specimen/Balsamiq+Sans

### Gráficos
- **Alvo** (contém alterações) — Nome original: "target_red2" | "Shooting Gallery" por Kenney: https://kenney.nl/assets/shooting-gallery
- **Espada** (contém alterações) — Nome original: "item_sword" | "Scribble Platformer" por Kenney: https://kenney.nl/assets/scribble-platformer
